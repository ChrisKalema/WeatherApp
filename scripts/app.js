const cityForm = document.querySelector('form');  //capture data from the form
...
const updateUI = (data) => {
    ...
    time.setAttribute('src', timesrc);   //change the card image to day or night
